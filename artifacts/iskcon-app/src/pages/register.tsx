...
const handleSignIn = async (e: React.FormEvent) => {
  ...
  const inputStyle = { borderColor: "hsl(14 30% 70% / 0.4)", color: "hsl(319 32% 19%)" };
  ...
  if (currentUser && registrationStep === 1) {
    ...
    const iSty = { borderColor: "hsl(14 30% 70% / 0.4)", color: "hsl(319 32% 19%)" };
  ...
  return (
    <div className="min-h-[100dvh] bg-background pb-16">
      <div className="px-5 pt-10 pb-6" style={{ background: "linear-gradient(110deg, hsl(40 58% 84%) 0%, hsl(37 50% 80%) 100%)" }}>
        ...
        <h1 className="font-serif font-bold" style={{ fontSize: "2.2rem", color: "hsl(319 32% 19%)" }}>Your Profile</h1>
        ...
        {tab === "signin" ? (
          ...
          <>
              ...
              <Field label="Community" required>
                <select required value={form.community} onChange={set("community")} className={inputCls} style={{ ...inputStyle, color: form.community ? "hsl(319 32% 19%)" : "hsl(14 30% 55%)" }}>
