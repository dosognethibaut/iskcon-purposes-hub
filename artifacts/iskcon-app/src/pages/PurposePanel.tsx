    ...
    <div className="mt-2">
      ...
      <div className="relative px-6 py-6">
        ...
        <div className="text-center">
          <p className="font-serif font-bold leading-relaxed" style={{ fontSize: "0.95rem", color: "hsl(14 52% 18%)" }}>
            {officialText}
          </p>
        </div>
        ...
        <p className="font-sans leading-relaxed text-center" style={{ fontSize: "0.88rem", color: "hsl(14 40% 38%)" }}>
          {description}
        </p>
      </div>
