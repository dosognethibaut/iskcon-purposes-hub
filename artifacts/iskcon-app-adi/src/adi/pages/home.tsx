...
import { useAuth } from "@/adi/context/AuthContext";
import { getBadges, getNotifications, markNotificationsReadAll, subscribeToLocalData } from "@/adi/lib/local-data";
      ...
      <div className="relative overflow-hidden" style={{ height: "100dvh" }}>
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="px-6 pb-2">
            ...
            >
              <p className="font-serif italic leading-relaxed text-center" style={{ fontSize: "clamp(1.15rem, 4.5vw, 1.45rem)", color: "hsl(40 70% 94%)" }}>
                <span style={{ color: "hsl(26 68% 62%)" }}>"</span>{quotes[current].text}<span style={{ color: "hsl(26 68% 62%)" }}>"</span>
              </p>
              <p className="font-sans mt-2 text-center" style={{ fontSize: "0.82rem", color: "hsl(26 60% 70%)", letterSpacing: "0.04em" }}>
                {quotes[current].ref}
              </p>
            </a>
